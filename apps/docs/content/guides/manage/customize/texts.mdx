...
If you need support for a specific language we highly encourage you to contribute translations.
See [Contribute Translations](https://github.com/zitadel/zitadel/blob/main/CONTRIBUTING.md#contribute-translations) and the [i18n README](https://github.com/zitadel/zitadel/blob/main/i18n/README.md) for how to edit unified locale files, export runtime catalogs, and register a new language.
